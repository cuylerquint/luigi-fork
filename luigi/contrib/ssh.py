...
class RemoteFileSystem(luigi.target.FileSystem):
    ...
    def put(self, local_path, path):
        ...
        tmp_path = path + '-luigi-tmp-%09d' % secrets.SystemRandom().randrange(0, 10_000_000_000)
...
class AtomicRemoteFileWriter(luigi.format.OutputPipeProcessWrapper):
    ...
    def __init__(self, fs, path):
        ...
        self.__tmp_path = self.path + '-luigi-tmp-%09d' % secrets.SystemRandom().randrange(0, 10_000_000_000)
